...
import HeadSomaticAssessment from "./HeadSomaticAssessment";

type HeadSomaticFlowProps = {
  courseId: string;
  gameId: string;
...
export default function HeadSomaticFlow({
  courseId,
  gameId,
  contentItemId,
  returnVideoId,
  ...
  return (
    <div className="space-y-4">
      <HeadSomaticAssessment selected={sensation} onSelect={onSelectSensation} />
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <h3 className="mt-2 text-xl font-semibold text-[var(--text)]">
                Stay on this screen and move through the head sequence
              </h3>
              <p className="mt-2 text-sm leading-6 text-[var(--muted)]">
                The body selection stays in place. Each head activity appears here based on the
                sensation you chose.
              </p>
            </div>
          ...
          <div className="mt-5 grid gap-5 xl:grid-cols-[320px_minmax(0,1fr)]">
            ...
            <div className="rounded-[24px] border border-[var(--border)] bg-[var(--surface)] p-5">
              ...
              <h4 className="mt-2 text-xl font-semibold text-[var(--text)]">
                Open each head practice on its own full page
              </h4>
              <p className="mt-3 max-w-xl text-sm leading-6 text-[var(--muted)]">
                Once you choose a head sensation, every recommended activity now opens as a dedicated
                full-screen practice. Finish or skip it there, then return here for the next one.
              </p>
                ...
                <div className="mt-5 rounded-[22px] border border-[var(--border)] bg-white p-4">
                  ...
                  <p className="mt-2 text-sm leading-6 text-[var(--muted)]">
                    {getSomaticScreenDefinition(activeActivityKey)?.intro ??
                      "Open the selected practice to continue this head pathway."}
                  </p>
