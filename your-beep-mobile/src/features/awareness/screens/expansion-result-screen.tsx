...
export function ExpansionResultScreen() {
  ...
  const fallbackResult = getExpansionResult(expansionSelections);
      ...
      try {
        ...
        setSubmissionMessage(
          error instanceof Error && error.message
            ? error.message
            : 'We could not sync step 2 right now.',
        );
        setSubmissionState('error');
      }
    })();
  }, [activationSelections, effectiveCourseId, effectiveGameId, expansionSelections, submissionState]);
